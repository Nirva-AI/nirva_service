...
#     # 是否有房间？！！
#     room_manager = game_server.user_session_manager
#     if not room_manager.has_user_session(request_data.user_name):
#         logger.error(
...
#     # 是否有游戏？！！
#     current_room = room_manager.get_user_session(request_data.user_name)
