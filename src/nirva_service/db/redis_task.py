...
def create_task(username: str, task_type: str) -> str:
    ...
    nirva_service.db.redis_client.redis_hmset(task_key, task_data)

    # 设置过期时间(7天)
    nirva_service.db.redis_client.redis_expire(task_key, seconds=60 * 60 * 24 * 7)
...
def update_task_status(
    ...
    nirva_service.db.redis_client.redis_hmset(task_key, updates)
...
def get_task_status(username: str, task_id: str) -> Dict[str, Any] | None:
    ...
    task_data = nirva_service.db.redis_client.redis_hgetall(task_key)
