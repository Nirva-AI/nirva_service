# from nirva_service.models import UserSession
...
#     user_session_data = nirva_service.db.redis_client.redis_hgetall(user_session_key)
...
#     redis_history_data = nirva_service.db.redis_client.redis_lrange(history_key, 0, -1)
...
#     # 更新用户基本信息
#     nirva_service.db.redis_client.redis_hset(
#         user_session_key,
#         {
...
#     # 首先删除旧的聊天历史
#     nirva_service.db.redis_client.redis_delete(history_key)

#     # 然后添加新的聊天历史
#     if user_session.chat_history:
#         for message in user_session.chat_history:
#             message_json = _serialize_message(message)
#             nirva_service.db.redis_client.redis_rpush(history_key, message_json)
...
#     assert username != "", "username cannot be an empty string."
#     # 删除用户会话和聊天历史
#     nirva_service.db.redis_client.redis_delete(_user_session_key(username))
#     nirva_service.db.redis_client.redis_delete(_user_history_key(username))
